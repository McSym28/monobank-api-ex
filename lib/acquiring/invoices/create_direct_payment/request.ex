defmodule MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request do
  @moduledoc """
  Provides struct and type for a Invoices.CreateDirectPayment.Request
  """
  ...
  @type t :: %__MODULE__{
          amount: integer,
          card_data: MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request.CardData.t(),
          ccy: integer | nil,
          ...
          save_card_data:
            MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request.SaveCardData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      card_data:
        {"cardData", {MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request.CardData, :t}},
      ...
      save_card_data:
        {"saveCardData",
         {MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request.SaveCardData, :t}},
