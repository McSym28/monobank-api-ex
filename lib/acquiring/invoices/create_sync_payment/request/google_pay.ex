defmodule MonobankAPI.Acquiring.Invoices.CreateSyncPayment.Request.GooglePay do
  @moduledoc """
  Provides struct and type for a Invoices.CreateSyncPayment.Request.GooglePay
  """
