defmodule MonobankAPI.Acquiring.Invoices.CreateSyncPayment.Request.CardData do
  @moduledoc """
  Provides struct and type for a Invoices.CreateSyncPayment.Request.CardData
  """
