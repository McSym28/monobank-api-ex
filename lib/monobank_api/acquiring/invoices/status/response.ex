defmodule MonobankAPI.Acquiring.Invoices.Status.Response do
  @moduledoc """
  Provides struct and type for a Invoices.Status.Response
  """
  ...
  @type t :: %__MODULE__{
          ...
          payment_info: MonobankAPI.Acquiring.Invoices.Status.Response.PaymentInfo.t() | nil,
          ...
          status:
            ...
            | :success
            | String.t(),
          tips_info: MonobankAPI.Acquiring.Invoices.Status.Response.TipsInfo.t() | nil,
          wallet_data: MonobankAPI.Acquiring.Invoices.Status.Response.WalletData.t() | nil
        }
  @type types :: :t
  ...
  def __fields__(:t) do
    [
      ...
      payment_info:
        {"paymentInfo", {MonobankAPI.Acquiring.Invoices.Status.Response.PaymentInfo, :t}},
      ...
      tips_info: {"tipsInfo", {MonobankAPI.Acquiring.Invoices.Status.Response.TipsInfo, :t}},
      wallet_data: {"walletData", {MonobankAPI.Acquiring.Invoices.Status.Response.WalletData, :t}}
    ]
  end
end
