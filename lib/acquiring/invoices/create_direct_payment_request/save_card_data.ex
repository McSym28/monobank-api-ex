defmodule MonobankAPI.Acquiring.Invoices.CreateDirectPaymentRequest.SaveCardData do
  @moduledoc """
  Provides struct and type for a Invoices.CreateDirectPaymentRequest.SaveCardData
  """
