defmodule MonobankAPI.Acquiring.Invoices.CreateSyncPaymentRequest.GooglePay do
  @moduledoc """
  Provides struct and type for a Invoices.CreateSyncPaymentRequest.GooglePay
  """
