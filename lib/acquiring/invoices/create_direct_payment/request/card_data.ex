defmodule MonobankAPI.Acquiring.Invoices.CreateDirectPayment.Request.CardData do
  @moduledoc """
  Provides struct and type for a Invoices.CreateDirectPayment.Request.CardData
  """
