defmodule MonobankAPI.Acquiring.Merchants.ListStatements.Response.ListItem do
  @moduledoc """
  Provides struct and type for a Merchants.ListStatements.Response.ListItem
  """
  ...
  @type t :: %__MODULE__{
          ...
          cancel_list:
            [MonobankAPI.Acquiring.Merchants.ListStatements.Response.ListItem.CancelListItem.t()]
            | nil,
          ccy: integer,
          date: DateTime.t(),
