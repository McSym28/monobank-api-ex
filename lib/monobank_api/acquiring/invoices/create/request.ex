defmodule MonobankAPI.Acquiring.Invoices.Create.Request do
  @moduledoc """
  Provides struct and type for a Invoices.Create.Request
  """
  ...
  @type t :: %__MODULE__{
          ...
          save_card_data: MonobankAPI.Acquiring.Invoices.Create.Request.SaveCardData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      save_card_data:
        {"saveCardData", {MonobankAPI.Acquiring.Invoices.Create.Request.SaveCardData, :t}},
